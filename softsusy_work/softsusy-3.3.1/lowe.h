...
const double ALPHASMZ = 0.1176; ///< default running mass from PDG
const double ALPHAMZ = 1.0 / 127.925; ///< default running alpha(MZ) from PDG

const double PMTOP = 173.3; ///< default pole mass from CDF/D0 Run II 1007.3178
