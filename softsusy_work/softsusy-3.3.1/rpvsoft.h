...
/** \file rpvsoft.h
   ...
   \brief R-Parity violating MSSM object including all (real)
...
/// Main class for R-parity violating MSSM. But: if you are assuming LEPTON
/// NUMBER VIOLATION, you should use the object RpvNeutrino, which inherits
/// from this base objet. However, for baryon number violation, RpvSoftsusy is
/// appropriate. 
class RpvSoftsusy: public FlavourMssmSoftsusy, public RpvSoftPars, public RpvSusyPars {
...
public:
  ...
  virtual void sparticleThresholdCorrections(double tb, const DoubleVector & pars);
  ...
  /// couplings 
  void outputGutScaleNonZeroInputs(ostream & out);
...
inline RpvSoftsusy::RpvSoftsusy()
  : FlavourMssmSoftsusy(), RpvSoftPars(), RpvSusyPars(), snuVevs(3), 
    nuMasses(3), neutralFermMixing(7, 7), Uch(5, 5), Vch(5, 5) {
...
/// other boundary conditions for RPV
